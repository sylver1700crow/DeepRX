...
class get_config():
    def __init__(self):
        ...
        self.parser.add_argument('--data_mode', type=str, default='CDL-A', help='data_mode: CDL-A, EVA, EPA')#
        ...
        self.parser.add_argument('--lr_scheduler', type=str, default='StepLR', help='loss function criterion')#'CosineAnnealingLR'
        ...
        self.parser.add_argument('--deepcnn', type=int, default=64, help='deep RX width')# width of the deeprx
